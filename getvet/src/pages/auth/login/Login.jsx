    ...
    <div className={styles.loginContainer}>
      ...
      <div className={styles.userType}>
        <label htmlFor="farmerRadio">
          <input type="radio" name="userType" value="farmers" id="farmerRadio" />
          <span id="farmerText">I'm a Farmer</span>
        </label>
        <label htmlFor="veterinarianRadio">
          <input type="radio" name="userType" value="veterinarians" id="veterinarianRadio" />
      ...
      <p className={styles.signupLink}>
        ...
        <a href="join-us.html" id="joinText">Join Us</a>
      </p>
    </div>
  );
}
